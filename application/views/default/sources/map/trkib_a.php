...
if(count($responden)>0) {
	...
	<tr><td>Detail Barang</td><td>:</td><td><?php echo $responden['detail_brg']; ?></td></tr>
	...
	<tr><td>Luas Tanah</td><td>:</td><td><?php echo $responden['luas']; ?> m2</td></tr>
	<tr><td>Status Tanah</td><td>:</td><td><?php echo $responden['status_tanah']; ?></td></tr>
	<tr><td>Sumber Dana</td><td>:</td><td><?php echo $responden['asal']; ?></td></tr>
	<tr><td>Penggunaan</td><td>:</td><td><?php echo $responden['penggunaan']; ?></td></tr>
	<tr><td>Pemegang Hak</td><td>:</td><td><?php echo $responden['pemegang_hak']; ?></td></tr>
	<tr><td>Alamat</td><td>:</td><td><?php echo $responden['alamat1']; echo $responden['alamat2']; ?></td></tr>
	<tr><td>Keterangan</td><td>:</td><td><?php echo $responden['keterangan']; ?></td></tr>
